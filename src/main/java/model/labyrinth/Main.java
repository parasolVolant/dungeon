import Graph.*;
import GraphClasses.*;
import RandomTreeAlgos.AldousBroderAlgorithm;
import RandomTreeAlgos.RandomPrim;
import RandomTreeAlgos.RandomizedWidthCourse;
...
//		Graph graph = new Lollipop(1_000).graph;
    ...
    public static ArrayList<Edge> genTree(Graph graph) {
        ...
        //ArrayList<Arc> randomArcTree = RandomPrim.generateTree(graph, 0);
        //ArrayList<Arc> randomArcTree = BreadthFirstSearch.generateTree(graph, 0);
        //ArrayList<Arc> randomArcTree = RandomizedWidthCourse.generateTree(graph, 0);
